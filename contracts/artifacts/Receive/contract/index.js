...
class _CoinPreimage_0 {
  alignment() {
    return _descriptor_11.alignment().concat(_descriptor_2.alignment().concat(_descriptor_5.alignment().concat(_descriptor_0.alignment())));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_11.toValue(value_0.domain_sep).concat(_descriptor_2.toValue(value_0.info).concat(_descriptor_5.toValue(value_0.dataType).concat(_descriptor_0.toValue(value_0.data))));
  }
}
...
class _ShieldedSendResult_0 {
  ...
  fromValue(value_0) {
    return {
      change: _descriptor_13.fromValue(value_0),
      sent: _descriptor_2.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_13.toValue(value_0.change).concat(_descriptor_2.toValue(value_0.sent));
  }
}

const _descriptor_14 = new _ShieldedSendResult_0();
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      spend: (...args_1) => {
        if (args_1.length !== 4) {
          throw new __compactRuntime.CompactError(`spend: expected 4 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const coin_0 = args_1[1];
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('spend',
                                     'argument 1 (as invoked from Typescript)',
                                     'Receive.compact line 12 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_4.toValue(coin_0).concat(_descriptor_8.toValue(recipient_0).concat(_descriptor_1.toValue(amount_0))),
            alignment: _descriptor_4.alignment().concat(_descriptor_8.alignment().concat(_descriptor_1.alignment()))
          },
          output: undefined,
          publicTranscript: [],
          privateTranscriptOutputs: []
        };
        const result_0 = this._spend_0(context,
                                       partialProofData,
                                       coin_0,
                                       recipient_0,
                                       amount_0);
  ...
  _spend_0(context, partialProofData, coin_0, recipient_0, amount_0) {
